...
) ENGINE=InnoDB AUTO_INCREMENT=1461 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='文章和分类的中间表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `article_cate` VALUES (1440,1,1),(1444,2,1),(1445,3,1),(1454,4,1),(1460,5,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='文章配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `article_config` VALUES (1,'default','',0,0,0,1),(2,'default','',0,0,0,2),(3,'default','',0,0,1,3),(4,'default','444',1,0,1,4),(5,'default','',0,0,0,5);
...
INSERT INTO `article_tag` VALUES (1,1,3),(2,2,3),(6,3,3);
...
INSERT INTO `cate` VALUES (1,'默认分类','💻','/','kfbj',0,1,'cate'),(67,'首页','💎','/','home',0,0,'nav'),(68,'足迹','⛳️','/footprint','zj',0,9,'nav'),(69,'关于我','👋','/my','my',0,14,'nav'),(70,'朋友圈','😇','/friend',' pyq',0,10,'nav'),(71,'留言墙','💌','/wall/all','wall',0,11,'nav'),(72,'GitHub','🔥','https://github.com/LiuYuYang01/ThriveX-Blog','github',0,999,'nav'),(73,'统计','📊','/data','data',0,8,'nav'),(74,'闪念','🏕️','/record','record',0,9,'nav'),(77,'我的设备','📷','/equipment',' wdsb',0,13,'nav'),(78,'标签页','🏷️','/tags','bqy',0,12,'nav'),(79,'我的履历','💪','/resume','wdll',0,15,'nav');
...
CREATE TABLE `comment` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=516 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `comment` VALUES (514,'宇阳','https://q1.qlogo.cn/g?b=qq&nk=3311118881&s=640','记得点个star','3311118881@qq.com','https://liuyuyang.net/',2187,0,0,'1729225111457'),(515,'ThriveX','https://q1.qlogo.cn/g?b=qq&nk=3311118881&s=640','太强了吧','3311118881@qq.com','https://liuyuyang.net',2,0,1,'1744980488518');
...
) ENGINE=InnoDB AUTO_INCREMENT=72 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='角色权限';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `swiper` VALUES (1,'半山腰的风景很美，然而我还是更想到山顶看看','The scenery halfway up the mountain is beautiful, but I still prefer to see the mountaintop','https://bu.dusays.com/2023/11/10/654e2cf6055b0.jpg','/'),(17,'这是一个轮播图','这是一个轮播图的描述','http://127.0.0.1:5000/1.jpg','/'),(18,'这是一个轮播图','这是一个轮播图的描述','http://127.0.0.1:5000/1.jpg','/'),(19,'这是一个轮播图','这是一个轮播图的描述','http://127.0.0.1:5000/1.jpg','/'),(20,'这是一个轮播图','这是一个轮播图的描述','http://127.0.0.1:5000/1.jpg','/'),(21,'这是一个轮播图','这是一个轮播图的描述','http://127.0.0.1:5000/1.jpg','/'),(22,'这是一个轮播图','这是一个轮播图的描述','http://127.0.0.1:5000/1.jpg','/'),(23,'这是一个轮播图','这是一个轮播图的描述','http://127.0.0.1:5000/1.jpg','/'),(24,'这是一个轮播图','这是一个轮播图的描述','http://127.0.0.1:5000/1.jpg','/'),(25,'这是一个轮播图','这是一个轮播图的描述','http://127.0.0.1:5000/1.jpg','/'),(26,'这是一个轮播图','这是一个轮播图的描述','http://127.0.0.1:5000/1.jpg','/'),(27,'这是一个轮播图','这是一个轮播图的描述','http://127.0.0.1:5000/1.jpg','/'),(28,'这是一个轮播图','这是一个轮播图的描述','http://127.0.0.1:5000/1.jpg','/');
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户 token';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_token` VALUES (27,1,'eyJhbGciOiJIUzI1NiJ9.-WIsOWvhueggSIsIm5hbWUiOiLlrofpmLMiLCJpbmZvIjoiVGhyaXZlWCDljZrlrqLnrqHnkIbns7vnu5_kvZzogIUiLCJlbWFpbCI6IjMzMTExMTg4ODFAcXEuY29tIiwiYXZhdGFyIjoiaHR0cHM6Ly9idS5kdXNheXMuY29tLzIwMjQvMTEvMTcvNjczOWFkZjE4OGY2NC5wbmciLCJyb2xlSWQiOiIxIiwicm9sZSI6bnVsbH19.Ir2vLo8lNOJj9RyfQCYW7flgUh1xOycNuKEN1TA-RDg');
...
-- Dump completed on 2025-04-19 12:25:30
